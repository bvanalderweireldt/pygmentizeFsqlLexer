# -*- coding: utf-8 -*-
"""
    pygments.lexers.fsql
    ~~~~~~~~~~~~~~~~~~~

    Lexers for Flexible Search Query dialect (SAP Hybris).
    
    More informations about fsql : http://javainsimpleway.com/flexible-search/
...
class FsqlLexer(RegexLexer):
    """
    Lexer for Flexible Search Query. Currently.
    """

    name = 'FSQL'
    aliases = ['fsql']
    filenames = ['*.fsql']
    mimetypes = ['text/x-fsql']
